	...
	<div class='col-md-12'>
		<div class='col-md-10 col-md-offset-1'>
			<div style='display:inline-block; width:100%; min-height:750px; background:#fff; padding:30px;'>
				<h4 style='margin:0;'>แผนข้อมูลประจำปี</h4>
				...
				<div class="row">
					<form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">หน่วยงาน : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">ปีงบประมาณ : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
								<select class="form-control">
									<option value="">--- เลือก ---</option>
								</select>
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">ยุทธศาสตร์ : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
								<select class="form-control">
									<option value="">--- เลือก ---</option>
								</select>
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">ประเภทแผนงาน : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
								<select class="form-control">
									<option value="">--- เลือก ---</option>
								</select>
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">ชื่อโครงการ : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
						      <input type="text" class="form-control" placeholder="ชื่อโครงการ" id="" name="" />
						    </div>
						</div>
						
						<div class="form-group">
						    <label class="col-sm-3 control-label">วันที่เริ่มต้น : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">วันที่สิ้นสุด : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
						      <div class='input-group'>
						...
						<div class="form-group">
						    <label class="col-sm-3 control-label">คู่สัญญา : <span class="text-red">*</span></label>
						    <div class="col-sm-5">
						      <input type="text" class="form-control" placeholder="คู่สัญญา" id="" name="" />
						    </div>
						    <div class="col-sm-2">
